    ...
    <div className="px-8 pb-7 [overflow-wrap:anywhere] @max-3xl/review:px-5 @max-3xl/review:pb-6">
      ...
      <div className="mt-6">
        <details className={DISCLOSURE}>
          ...
          <dl className="text-dense pb-4 pl-5.5 [&_dt]:mb-1 [&_dt]:[font-weight:550] [&>div]:mb-4">
...
function EvidenceLinks({
  ...
  return (
    <ul className="text-meta mt-2 flex flex-wrap gap-x-4 gap-y-1 [&_a]:inline-flex [&_a]:min-h-6 [&_a]:items-center [&_a]:underline [&_a]:underline-offset-3">
      {ids.map((id) => {
